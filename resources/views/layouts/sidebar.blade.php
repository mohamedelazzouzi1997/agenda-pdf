...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="#" class="flex"><img class="" src="../assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <div class="image"><a href="#"><img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" alt="User"></a></div>
                    <div class="detail">
            ...
            <li class="{{ Request::segment(1) === 'my-profile' ? 'active open' : null }}"><a href="#"><i class="zmdi zmdi-plus-circle text-green-500"></i><span class="hover:text-green-500">Ajouter Notification</span></a></li>
